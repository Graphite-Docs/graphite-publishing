        ...
        <div>
        {
          ...
          <nav className="navbar-fixed single-post-header">
            <div className="nav-wrapper">
              ...
              <ul className="right">
                {loading === true ? <button className="btn post-save-button grey">Saving</button> : <button onClick={this.props.handleSavePost} className="btn post-save-button blue">Save</button>}
              </ul>
            </div>
          </nav>
        }
